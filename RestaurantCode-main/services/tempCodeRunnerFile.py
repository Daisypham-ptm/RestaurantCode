...
def add_menu_item():
    while True:
        try:
            ...
            if input("Confirm add item? (y/n): ").lower() != "y":
                print("Cancelled")
...
def update_menu_item():
    while True:
        ...
        try:
            ...
            if input("Confirm update item? (y/n): ").lower() != "y":
                print("Cancelled")
                if not continue_or_back():
                    break
                continue
...
def delete_menu_item():
    while True:
        ...
        try:
            ...
            if input("Confirm delete item? (y/n): ").lower() != "y":
                print("Cancelled")
                if not continue_or_back():
                    break
                continue
...
def add_category():
    while True:
        ...
        if input("Confirm add category? (y/n): ").lower() != "y":
            print("Cancelled")
            if not continue_or_back():
                break
            continue
...
def update_category():
    while True:
        ...
        try:
            ...
            if input("Confirm update category? (y/n): ").lower() != "y":
                print("Cancelled")
                if not continue_or_back():
                    break
                continue
...
def delete_category():
    while True:
        ...
        try:
            cid = int(input("Category ID: "))
            if input("Confirm delete category? (y/n): ").lower() != "y":
                print("Cancelled")
                if not continue_or_back():
                    break
                continue
...
def update_order_status():
    while True:
        ...
        try:
            ...
            status = input("New status: ").upper()

            if input("Confirm update status? (y/n): ").lower() != "y":
                print("Cancelled")
                if not continue_or_back():
                    break
                continue
...
def update_user():
    while True:
        ...
        try:
            ...
            role = input("New role (admin/customer): ")

            if input("Confirm update user? (y/n): ").lower() != "y":
                print("Cancelled")
                if not continue_or_back():
                    break
                continue
...
def delete_user():
    while True:
        ...
        try:
            uid = int(input("User ID: "))
            if input("Confirm delete user? (y/n): ").lower() != "y":
                print("Cancelled")
                if not continue_or_back():
                    break
                continue
