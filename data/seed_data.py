...
# ===== USERS =====
users = [
    ("admin@email.com", "123456", "Admin", "0900000000", "admin"),
    ("cus1@email.com", "678910", "Customer One", "0911111111", "customer"),
    ("cus2@email.com", "123098", "Customer Two", "0922222222", "customer"),
]


cur.executemany("""
INSERT INTO users (email, password, full_name, phone_number, role)
VALUES (?, ?, ?, ?, ?)
""", users)
